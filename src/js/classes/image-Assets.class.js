...
export class ImageAssets {
  ...
  static CHARAKTER_SWIMMING = [
    ...
    "src/img/1.Sharkie/3.Swim/3.png",
    "src/img/1.Sharkie/3.Swim/4.png",
    "src/img/1.Sharkie/3.Swim/5.png",
  ...
  static CHARAKTER_BUBBLE_ATTACK = [
    ...
    "src/img/1.Sharkie/4.Attack/Bubble trap/Op2 (Without Bubbles)/3.png",
    "src/img/1.Sharkie/4.Attack/Bubble trap/Op2 (Without Bubbles)/4.png",
    "src/img/1.Sharkie/4.Attack/Bubble trap/Op2 (Without Bubbles)/5.png",
    "src/img/1.Sharkie/4.Attack/Bubble trap/Op2 (Without Bubbles)/6.png",
  ...
  static CHARAKTER_FIN_SLAP_ATTACK = [
    ...
    "src/img/1.Sharkie/4.Attack/Fin slap/3.png",
    "src/img/1.Sharkie/4.Attack/Fin slap/4.png",
    "src/img/1.Sharkie/4.Attack/Fin slap/5.png",
    "src/img/1.Sharkie/4.Attack/Fin slap/6.png",
    "src/img/1.Sharkie/4.Attack/Fin slap/7.png",
  ...
  static FISH_GREEN_TRANSITION = [
    ...
    "src/img/2.Enemy/1.Puffer fish/2.transition/1.transition3.png",
    "src/img/2.Enemy/1.Puffer fish/2.transition/1.transition4.png",
  ...
  static FISH_GREEN_BUBBLE_SWIMMING = [
    ...
    "src/img/2.Enemy/1.Puffer fish/3.Bubbleeswim/1.bubbleswim3.png",
    "src/img/2.Enemy/1.Puffer fish/3.Bubbleeswim/1.bubbleswim4.png",
  ...
  static BOSS_INTRO = [
    ...
    "src/img/2.Enemy/3 Final Enemy/1.Introduce/3.png",
    "src/img/2.Enemy/3 Final Enemy/1.Introduce/4.png",
    "src/img/2.Enemy/3 Final Enemy/1.Introduce/5.png",
    "src/img/2.Enemy/3 Final Enemy/1.Introduce/6.png",
    "src/img/2.Enemy/3 Final Enemy/1.Introduce/7.png",
    "src/img/2.Enemy/3 Final Enemy/1.Introduce/8.png",
    "src/img/2.Enemy/3 Final Enemy/1.Introduce/9.png",
  ...
  static BOSS_ATTACK = [
    ...
    "src/img/2.Enemy/3 Final Enemy/Attack/3.png",
    "src/img/2.Enemy/3 Final Enemy/Attack/4.png",
    "src/img/2.Enemy/3 Final Enemy/Attack/5.png",
  ...
  static BOSS_HURT = [
    ...
    "src/img/2.Enemy/3 Final Enemy/Hurt/3.png",
  ...
  static BOSS_DEAD = [
    ...
    "src/img/2.Enemy/3 Final Enemy/Dead/Mesa de trabajo 2 copia 7.png",
    "src/img/2.Enemy/3 Final Enemy/Dead/Mesa de trabajo 2 copia 8.png",
    "src/img/2.Enemy/3 Final Enemy/Dead/Mesa de trabajo 2 copia 9.png",
